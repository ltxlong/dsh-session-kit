window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      repairSessionDesc: '清除 dsh-session-kit 写进会话日志的越界字段与删除墓碑。\n被删除轮次的原生消息会保留并恢复显示。',
    ...
    const en = {
      ...
      repairSessionDesc: 'Clears the out-of-schema fields and deletion tombstones dsh-session-kit wrote into the session log.\nMessages of deleted turns are kept and become visible again.',
